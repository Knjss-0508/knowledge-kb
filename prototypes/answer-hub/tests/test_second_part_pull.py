...
def test_pull_second_part_page_maps_records_and_queues_workbook(
    tmp_path: Path,
    monkeypatch,
) -> None:
    monkeypatch.setenv("SECOND_PART_QUERY_FROM_DATE", "2026-08-01")
    monkeypatch.setenv("SECOND_PART_QUERY_TO_DATE", "2026-08-07")
    ...
    assert metadata["options"]["knowledge_settle_from_date"] == "2026-08-01"
    assert metadata["options"]["knowledge_settle_to_date"] == "2026-08-07"
