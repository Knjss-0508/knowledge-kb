...
class EmbeddingTrainingJob(Base):
    ...
    runner_access_token_hash = Column(String(64), nullable=True)
    runner_access_issued_at = Column(DateTime, nullable=True)
    runner_access_expires_at = Column(DateTime, nullable=True, index=True)
    runner_access_last_used_at = Column(DateTime, nullable=True)
    runner_access_issued_by = Column(String(128), nullable=True)
