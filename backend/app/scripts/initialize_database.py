...
def validate_schema() -> None:
    ...
    required_constraints = {
        ...
        "knowledge_vector_tasks_pkey",
        "knowledge_vector_tasks_knowledge_id_fkey",
    ...
    required_columns = {
        ...
        ("knowledge_vector_tasks", "knowledge_id"),
        ("knowledge_vector_tasks", "task_type"),
        ("knowledge_vector_tasks", "content_hash"),
        ("knowledge_vector_tasks", "status"),
        ("knowledge_vector_tasks", "attempt_count"),
        ("knowledge_vector_tasks", "next_attempt_at"),
        ("knowledge_vector_tasks", "lease_expires_at"),
        ("knowledge_vector_tasks", "started_at"),
        ("knowledge_vector_tasks", "completed_at"),
        ("knowledge_vector_tasks", "error_message"),
        ("knowledge_vector_tasks", "created_at"),
